...
//                Log.d(TAG, " SuspectedStartActivityString: "+t.getSuspectedStartActivityString());
//                Log.d(TAG, " SuspectedStopActivityString: "+t.getSuspectedStopActivityString());
//                Log.d(TAG, " SuspectedTime: "+String.valueOf(t.getSuspectedTime()));
//                Log.d(TAG, "taskDayCount: "+t.getTaskDayCount());
...
//        //Log.d(LOG_TAG, " examineTransportation you find " + recordPool.size() + " records in the activity recognition pool");
        ...
        for (int i=0; i<recordPool.size(); i++) {
            ...
            ActivityRecognitionDataRecord record = recordPool.get(i);
