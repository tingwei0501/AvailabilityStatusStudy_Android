...
//        int session_id = sharedPrefs.getInt("ongoingSessionid", Constants.INVALID_INT_VALUE);
        ...
        android.util.Log.d(TAG, "isIsWifiConnected " + mIsWifiConnected + ", NetworkType " + mNetworkType
                + ", mIsNetworkAvailable " + mIsNetworkAvailable + ", isIsMobileConnected " + mIsMobileConnected);
