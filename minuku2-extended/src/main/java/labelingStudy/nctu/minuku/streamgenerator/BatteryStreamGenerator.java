...
public class BatteryStreamGenerator extends AndroidStreamGenerator<BatteryDataRecord> {
    ...
    public static String mBatteryChargingState = "NA";
    ...
    public boolean updateStream() {
        ...
        Log.d(TAG, "detectedTime: " + detectedTime + ", BatteryChargingState " + mBatteryChargingState + ", BatteryPercentage " + mBatteryPercentage
                         + ", BatteryLevel " + mBatteryLevel + ", isCharging " + isCharging);
        // also post an event.
    ...
    private BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(Intent.ACTION_BATTERY_CHANGED)) {
                ...
                Log.d("BatteryLevel", String.valueOf(mBatteryLevel));
