...
//        ringerModeDataPool = new ArrayList<>();
...
//        int session_id = sharedPrefs.getInt("ongoingSessionid", Constants.INVALID_INT_VALUE);
        ...
        Log.d(TAG, "RingerMode: " + mRingerMode + ", AudioMode " + mAudioMode + "StreamVolumeMusic " + mStreamVolumeMusic + ", StreamVolumeNotification "
                         + mStreamVolumeNotification);
        // also post an event.
